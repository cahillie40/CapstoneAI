...
public class ModelExplanationService {
    ...
    public ModelExplanationDTO getExplanation() {
        List<FeatureWeightDTO> featureWeights = List.of(
                ...
                new FeatureWeightDTO("assists", 0.18, "Providing assists improves creative output and attacking value."),
                new FeatureWeightDTO("shotsOnTarget", 0.16, "More shots on target show attacking threat and better finishing involvement."),
                new FeatureWeightDTO("passAccuracy", 0.3, "Accurate passing supports control, retention, and technical quality."),
                new FeatureWeightDTO("expectedGoals", .28, "Higher xG means the player is getting into better scoring positions."),
                ...
                new FeatureWeightDTO("progressivePasses", 0.11, "Progressive passes help move the ball forward into dangerous areas."),
                ...
                new FeatureWeightDTO("ballRecoveries", 0.09, "Recovering the ball helps the team regain possession."),
                new FeatureWeightDTO("matchesMissed", -0.6, "Missing matches reduces consistency, readiness, and availability."),
                new FeatureWeightDTO("recentMatchLoad", 0.12, "Heavy recent workload may reduce freshness and increase fatigue risk."),
                new FeatureWeightDTO("injuryStatus", 0.15, "Being injured has a strong negative impact on predicted readiness."),
