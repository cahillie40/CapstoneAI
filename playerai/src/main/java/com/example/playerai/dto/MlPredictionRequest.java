...
public class MlPredictionRequest {
    ...
    public Boolean getInjuryStatus() { return injuryStatus; }
    public void setInjuryStatus(Boolean injuryStatus) { this.injuryStatus = injuryStatus; }
    ...
    public Integer getProgressivePasses() { return progressivePasses; }
    public void setProgressivePasses(Integer progressivePasses) { this.progressivePasses = progressivePasses; }
    public Integer getDribblesCompleted() { return dribblesCompleted; }
    public void setDribblesCompleted(Integer dribblesCompleted) { this.dribblesCompleted = dribblesCompleted; }
    ...
    public void setBallRecoveries(Integer ballRecoveries) { this.ballRecoveries = ballRecoveries; }
    public Integer getMatchesMissed() { return matchesMissed; }
    public void setMatchesMissed(Integer matchesMissed) { this.matchesMissed = matchesMissed; }
    public Integer getRecentMatchLoad() { return recentMatchLoad; }
    public void setRecentMatchLoad(Integer recentMatchLoad) { this.recentMatchLoad = recentMatchLoad; }
}